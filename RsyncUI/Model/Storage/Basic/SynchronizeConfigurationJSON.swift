...
struct SynchronizeConfigurationJSON: Identifiable, Codable {
    var id = UUID()
    var hiddenID: Int
    var task: String
...
extension SynchronizeConfigurationJSON: Hashable, Equatable {
    static func == (lhs: SynchronizeConfigurationJSON, rhs: SynchronizeConfigurationJSON) -> Bool {
